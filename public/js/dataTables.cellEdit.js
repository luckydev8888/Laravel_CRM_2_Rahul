...
jQuery.fn.dataTable.Api.register("MakeCellsEditable()", function (settings) {
    ...
    jQuery.fn.extend({
        ...
        updateEditableCell: function (callingElement) {
            ...
            // table.draw(true);
            $.ajax({
                url: base_url + "/contacts/editcolumn",
                type: "post",
                data: {
                    _token: token,
                    id: row.data().id,
        ...
        drawFinished: function (callingElement) {
    ...
    switch (inputType) {
        ...
        case "list-confirm": // List w/ confirm
            ...
            input.html =
                ...
                confirmCss +
                "' onclick='$(this).updateEditableCell(this);'><i class=\"fa fa-save\"></i></a> <a href='javascript:void(0);' class='" +
                cancelCss +
                "' onclick='$(this).cancelEditableCell(this)'><i class=\"fa fa-ban\"></i></a>" +
                endWrapperHtml;
            input.focus = false;
            break;
        ...
        case "textarea":
            input.html =
                ...
                inputCss +
                "'  onfocusout='$(this).updateEditableCell(this)' >" +
                oldValue +
                "</textarea>" +
                endWrapperHtml;
            break;
